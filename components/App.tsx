...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-[#1F2937] font-sans selection:bg-[#2563EB]/20">
      ...
      <main>
        ...
        {/* Demo Section - Replaced Unified Product Hub with One Click Integrations */}
        <section id="automation-demo" className="py-24 bg-white overflow-hidden relative border-t border-gray-50">
          <div className="max-w-7xl mx-auto px-6">
            
            {/* Indian Marketplace Integration Header & Grid */}
            <IntegrationsGrid />
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="p-6 bg-blue-50 border border-blue-100 rounded-2xl">
                   <h4 className="flex items-center gap-2 text-[#2563EB] font-bold text-sm mb-2">
                     ...
                     Indian Marketplace Ready
                   </h4>
                   <p className="text-[11px] text-blue-600 leading-relaxed">Our AI automatically detects the best HSN/GST slab and maps your content to Amazon.in, Flipkart, and Meesho templates with technical precision.</p>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="bg-[#121214] rounded-3xl overflow-hidden border border-gray-800 shadow-2xl flex flex-col h-full min-h-[600px]">
                  <div className="bg-[#1a1a1c] px-6 py-4 flex items-center justify-between border-b border-gray-800">
                    ...
                    <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">Processing Artifact: {results ? results.parent.sku : 'SKU_IN_MASTER'}</div>
                  </div>
                      ...
                      <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                        ...
                        <div className="bg-green-500/5 border border-green-500/20 p-4 rounded-xl flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-green-500/70 text-xs">Compliance verified (HSN {results.parent.hsn}, GST {results.parent.gst_rate}%).</p>
                          </div>
                        </div>
  ...
  <div className="px-6">
    ...
    <div className="flex flex-col items-start gap-3">
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 bg-[#2563EB] rounded flex items-center justify-center font-bold text-white text-sm">
          L
        </div>
      ...
      <p className="text-gray-500 text-sm max-w-md">
        The #1 multi-marketplace listing automation platform for Indian sellers of all products.
      </p>
    </div>
  ...
  {/* Bottom Line */}
  <div className="px-6 mt-8 text-gray-400 text-xs font-mono text-left">
    India-first. All Products. © 2024 ListSync AI
  </div>
